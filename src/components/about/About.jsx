...
const About = () => {
    return (
        ...
        <div className="a-right">
            ...
            <p className="a-desc">I am motivated by technology and I love building solutions that make life better. My current focus is on building software with with Python and JavaScript. Check out my <a href="https://github.com/collinskandie">GitHub profile</a> for my previous and current projetcs. You can also check it <a href="https://github.com/collinskandie">here</a></p>
            <br></br>
